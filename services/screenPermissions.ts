  ...
  shipments: {
    ...
    actions: [
      ...
      },
      {
        ...
        label: 'Preparar paquete listo',
        permissionCode: 'MANAGE_SHIPMENTS',
        allowedMessage: 'Puedes convertir un paquete listo en envio operativo.',
        deniedMessage: 'No puedes preparar paquetes para envio.',
      },
      {
        key: 'registerGuide',
        label: 'Registrar guia o referencia',
        permissionCode: 'MANAGE_SHIPMENTS',
        allowedMessage: 'Puedes capturar guia o referencia de paqueteria.',
        deniedMessage: 'No puedes registrar guia o referencia.',
      },
      {
        key: 'markShipped',
        label: 'Marcar enviado',
        permissionCode: 'MANAGE_SHIPMENTS',
        allowedMessage: 'Puedes marcar envios como enviados desde el detalle.',
        deniedMessage: 'No puedes marcar envios como enviados.',
      },
      {
        key: 'confirmReceived',
        label: 'Confirmar recibido',
        permissionCode: 'MANAGE_SHIPMENTS',
        allowedMessage: 'Puedes confirmar entregas o resultados de envio.',
    ...
    actions: [
      ...
      },
      {
      ...
      },
        {
          ...
          label: 'Marcar enviado',
          permissionCode: 'MANAGE_SHIPMENTS',
          allowedMessage: 'Puedes marcar envios como enviados cuando tienen datos minimos.',
          deniedMessage: 'No puedes marcar envios como enviados.',
        },
        {
          key: 'confirmDelivery',
        ...
        },
        {
          ...
          label: 'Cancelar o reabrir envio',
          permissionCode: 'MANAGE_SHIPMENTS',
          allowedMessage: 'Puedes cancelar o reabrir envios segun su estado.',
          deniedMessage: 'No puedes cancelar ni reabrir envios.',
        },
        {
          key: 'viewRelatedPackage',
          label: 'Ver paquete relacionado',
          permissionCode: 'CREATE_CLOSE_CUSTOMER_PACKAGE',
          allowedMessage: 'Puedes abrir el paquete relacionado desde el detalle del envio.',
          deniedMessage: 'No puedes abrir el paquete relacionado desde este detalle.',
        },
      ],
    },
  liveAuthorizations: {
