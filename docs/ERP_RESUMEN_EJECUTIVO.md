...
Alcance: Fase 0 a Fase 2O y LIVE-A, incluyendo RC candidato Fase 1, smoke runtime tenant-aware, primeras tablas P0 tenant-aware, lotes tenant-aware runtime, dataset QA Empresa A/B, validacion runtime A/B y base i18n frontend para LIVE.
