...
Alcance: Fase 0 a Fase 2G, incluyendo RC candidato Fase 1 y validacion tenant-aware runtime.
...
- Fase 2D/2F/2G: bootstrap tenant minimo y sesiones tenant-aware implementadas; runtime reiniciado valida `/api/tenant/current`, dashboard y sucursales. No migrar P0 todavia porque falta dataset QA completo de `qa.sinpermisos`, `qa.reportes` y `qa.soporte`.
...
| Auditoria | 38% |
| Seguridad | 65% |
| Multi-compania / SaaS readiness | 44% |
| QA | 74% |
| UX homogenea | 48% |
| Trazabilidad | 50% |
| Gobernanza ERP | 76% |
| ERP readiness general | 69% |
...
5. Completar dataset QA faltante para permisos/reportes/soporte y repetir smoke tenant-aware.
6. Mantener ventas/pagos/reportes fuera de alcance hasta cerrar validacion 2G/2H.
